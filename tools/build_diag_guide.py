...
TRACKS = [
    ...
    },
    {
        ...
        'steps': [
            {'q': '主要困扰是哪一类？', 'opts': [
                {'t': '经行小腹疼痛', 'add': ['jing_tong']},
                {'t': '月经周期紊乱', 'add': ['jing_diao']},
                {'t': '带下异常', 'add': []},
                {'t': '产后恶露或乳汁问题', 'add': []}]},
            {'q': '经血的颜色质地？（无相关问题可跳过）', 'opts': [
                {'t': '紫暗、夹血块', 'add': ['yj_anh']},
                {'t': '色淡、质稀', 'add': ['yj_dan']},
                {'t': '量多或淋沥不尽', 'add': ['yj_bld']}]},
            {'q': '带下是什么样？（无相关问题可跳过）', 'opts': [
                {'t': '清稀色白、量多、无异味', 'add': ['dai_bai']},
                {'t': '黄稠、有异味、伴瘙痒', 'add': ['dai_huang', 'dai_du']},
                {'t': '产后恶露三周不尽', 'add': ['chanhr_xu']},
                {'t': '产后乳汁清稀量少', 'add': ['chan_ru_shao']}]},
            {'q': '平时还有哪些表现？', 'opts': [
                {'t': '胸胁乳房胀痛、易怒或抑郁', 'add': ['xiezhang', 'yiyu']},
                {'t': '神疲乏力、食欲差、便溏', 'add': ['shenpi', 'nadai', 'dabian_tang']},
                {'t': '口苦口黏、小便黄', 'add': ['kouku', 'niao_duan']},
                {'t': '面色无华、心悸失眠', 'add': ['mianbai', 'xinji', 'shimian']}]},
            {'q': '舌脉偏哪一类？', 'opts': [
                {'t': '舌紫暗或有瘀斑、脉涩', 'add': ['she_zi', 'mai_se']},
                {'t': '舌淡苔白、脉细弱', 'add': ['she_danbai', 'mai_xiruo']},
                {'t': '舌苔黄腻、脉弦数', 'add': ['she_huangni', 'mai_xian']},
                {'t': '苔白腻、脉缓', 'add': ['she_baini', 'mai_xiruo']}]}]
    },
    {
        'id': 'er_ke', 'name': '小儿不适', 'icon': '🧒', 'desc': '食积、夜啼、惊风、遗尿',
        'base': [],
        'steps': [
            {'q': '孩子主要怎么了？', 'opts': [
                {'t': '不吃东西、肚胀、嗳腐', 'add': ['er_jishi', 'er_dabian_chou']},
                {'t': '面黄肌瘦、肚大青筋', 'add': ['er_gan', 'er_wei_ruo']},
                {'t': '突然高热', 'add': ['er_jire']},
                {'t': '睡中遗尿', 'add': ['er_yn']}]},
            {'q': '有没有惊惕抽搐的迹象？', 'opts': [
                ...
                {'t': '没有', 'add': []}]},
            {'q': '出汗与睡眠情况？', 'opts': [
                {'t': '睡中盗汗、自汗明显', 'add': ['er_qire']},
                {'t': '烦躁不安、睡不踏实', 'add': ['fanshen', 'shimian']},
                {'t': '没有明显异常', 'add': []}]},
            {'q': '大便情况？', 'opts': [
                {'t': '酸臭、夹不消化食渣', 'add': ['er_dabian_chou']},
                {'t': '稀溏', 'add': ['dabian_tang']},
                {'t': '正常', 'add': []}]},
            {'q': '舌脉偏哪一类？', 'opts': [
